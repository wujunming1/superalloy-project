...
#条件熵
    ...
    def fit(self, filename):
        ...
        self.metafeatures["MissingValues"] = self.MissingValues(X, y, categorical)
        self.metafeatures["NumberOfInstancesWithMissingValues"] = self.NumberOfInstancesWithMissingValues(X, y, categorical)
        self.metafeatures["PercentageOfInstancesWithMissingValues"] = self.PercentageOfInstancesWithMissingValues(X, y,
                                                                                                        categorical)
        self.metafeatures["NumberOfFeaturesWithMissingValues"] = self.NumberOfFeaturesWithMissingValues(X, y, categorical)
        self.metafeatures["PercentageOfFeaturesWithMissingValues"] = self.PercentageOfFeaturesWithMissingValues(X, y, categorical)
        self.metafeatures["NumberOfMissingValues"] = self.NumberOfMissingValues(X, y, categorical)
        self.metafeatures["PercentageOfMissingValues"] = self.PercentageOfMissingValues(X, y, categorical)
...
def calculate(data_path):
    ...
    data[2] = mf.metafeatures["NumberOfFeatures"]
    data[3] = mf.metafeatures["LogNumberOfFeatures"]
    data[4] = mf.metafeatures["NumberOfOutliers"]
    data[5] = mf.metafeatures["PercentageOfInstancesWithOutliers"]
    data[6] = mf.metafeatures["NumberOfInstancesWithMissingValues"]
    data[7] = mf.metafeatures["PercentageOfInstancesWithMissingValues"]
    data[8] = mf.metafeatures["NumberOfFeaturesWithMissingValues"]
    data[9] = mf.metafeatures["PercentageOfFeaturesWithMissingValues"]
    data[10] = mf.metafeatures["NumberOfMissingValues"]
    data[11] = mf.metafeatures["PercentageOfMissingValues"]
    data[12] = mf.metafeatures["NumberOfNumericFeatures"]
    data[13] = mf.metafeatures["NumberOfCategoricalFeatures"]
    data[14] = mf.metafeatures["RatioNumericalToNominal"]
    data[15] = mf.metafeatures["RatioNominalToNumerical"]
    data[16] = mf.metafeatures["DatasetRatio"]
    data[17] = mf.metafeatures["LogDatasetRatio"]
    data[18] = mf.metafeatures["InverseDatasetRatio"]
    data[19] = mf.metafeatures["LogInverseDatasetRatio"]
    data[20] = mf.metafeatures["SymbolsMin"]
    data[21] = mf.metafeatures["SymbolsMax"]
    data[22] = mf.metafeatures["SymbolsMean"]
    data[23] = mf.metafeatures["SymbolsSTD"]
    data[24] = mf.metafeatures["SymbolsSum"]
    data[25] = mf.metafeatures["KurtosisMin"]
    data[26] = mf.metafeatures["KurtosisMax"]
    data[27] = mf.metafeatures["KurtosisMean"]
    data[28] = mf.metafeatures["KurtosisSTD"]
    data[29] = mf.metafeatures["SkewnessMin"]
    data[30] = mf.metafeatures["SkewnessMax"]
    data[31] = mf.metafeatures["SkewnessMean"]
    data[32] = mf.metafeatures["SkewnessSTD"]
    data[33] = mf.metafeatures["LandmarkLDA"]
    data[34] = mf.metafeatures["LandmarkNaiveBayes"]
    data[35] = mf.metafeatures["LandmarkDecisionTree"]
    data[36] = mf.metafeatures["LandmarkDecisionNodeLearner"]
    data[37] = mf.metafeatures["LandmarkRandomNodeLearner"]
    data[38] = mf.metafeatures["Landmark1NN"]
    data[39] = mf.metafeatures["PCAFractionOfComponentsFor95PercentVariance"]
    data[40] = mf.metafeatures["PCAKurtosisFirstPC"]
    data[41] = mf.metafeatures["PCASkewnessFirstPC"]
...
def insert(data_path,file_name,user_name):
    mf_list = ['NumberOfInstances', 'LogNumberOfInstances', 'NumberOfFeatures',
               ...
               'PercentageOfInstancesWithOutliers', 'NumberOfInstancesWithMissingValues',
               'PercentageOfInstancesWithMissingValues',
               'NumberOfFeaturesWithMissingValues', 'PercentageOfFeaturesWithMissingValues', 'NumberOfMissingValues',
    ...
    df.to_csv('D:\\superlloy\\automl\\cluster\\selection\\meta-feature\\' +
                    file_name.rstrip('.xls') + '_' + 'MetaFeatures.csv')
