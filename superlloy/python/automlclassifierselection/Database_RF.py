...
def insert(file_name,file_path,user_name):
    db = Connectdatabase()
    ...
    # df_Test.to_csv(
    #     'D:\\gwhj\\superlloy\\automl\\cluster\\selection\\recommend_rf\\' + file_name.split('.')[0] + '_rf.csv')

    date = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())
    file_name = file_name
    user_name = user_name
    temp_recommend = ['knn', 'svc', 'sgd']
    type = 'RF_Based'
...
if __name__ == '__main__':
    # Train2Result_path = 'D:\\gwhj\\superlloy\\automl\\cluster\\selection\\Train2\\Train2_Result.csv'
    # Train2Result_df = pd.read_csv(Train2Result_path)
    # Train2Result_values = Train2Result_df.values
    #
    # Train2ItemPath = 'D:\\gwhj\\superlloy\\automl\\cluster\\selection\\Train2\\Train2-ItemBased.csv'
    # Train2UserPath = 'D:\\gwhj\\superlloy\\automl\\cluster\\selection\\Train2\\Train2-UserBased.csv'
    # Train2ModelPath = 'D:\\gwhj\\superlloy\\automl\\cluster\\selection\\Train2\\Train2-ModelBased.csv'
    ...
    # username = 'piki'
    insert(parameterlist[0], parameterlist[1], parameterlist[2])
    # insert('auto-test.xlsx', r'D:\gwhj\superlloy\data\piki\auto-test.xlsx', 'piki', model_list, alg)
