...
#插入数据操作
def insert(file_name,file_path,alg,threshold,branching_factor,username):
    ...
    branching_factor = int(float(branching_factor))

    try:
        model, label, score = birch(data, threshold, branching_factor)
    except Exception as err:
        print(err)
...
if __name__ == '__main__':
    #python .py file_name0 file_path1 birch threshold3  branching_factor4 username5
