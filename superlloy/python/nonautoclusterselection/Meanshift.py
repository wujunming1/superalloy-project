...
#插入数据操作
def insert(file_name,file_path,alg,bandwidth,min_bin_freq,username):
    ...
    print(bandwidth,min_bin_freq)

    try:
        model, label, score = meanshift(data, bandwidth, min_bin_freq)
    except Exception as err:
        print(err)
...
if __name__ == '__main__':
    #python .py file_name0 file_path1 meanshift2 bandwidth3 min_bin_freq4 username5
