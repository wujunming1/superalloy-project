                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-success">
                        ...
                        <div id="myTabContent1" class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="recommendation1">
                                <div class="row">
                                    <div class="col-md-6" class="table-responsive" style="overflow:auto;">
                                        <table id="recommendationTable1" class="table-responsive">
                        ...
                        <div id="myTabContent2" class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="recommendation2">
                                <div class="row">
                                    <div class="col-md-6" class="table-responsive" style="overflow:auto;">
                                        <table id="recommendationTable2" class="table-responsive">
                        ...
                        <div id="myTabContent3" class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="recommendation3">
                                <div class="row">
                                    <div class="col-md-6" class="table-responsive" style="overflow:auto;">
                                        <table id="recommendationTable3" class="table-responsive">
                        ...
                        <div >
                            <input class=" btn btn-success radius f-r height-auto size-X" type="button" onclick="Recommend_RF();" value="下一步" >
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function getRecommend_User(eCode) {
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/AutoMlClassifierSelection/Recommend_User",
            ...
            success:function (result) {
                $("#TabContent1").hide();
                var User_recommend = result['alg_recommend'];
                getRecommendation_User(User_recommend);
            },
            complete: function () {
                reloadpage();
            }
    ...
    function getRecommendation_User(User_recommend) {
        var tableTitle = [];
        var tableData = [];
        var i;
        for(i=0;i<3;i++){
        ...
        var temp = {};
        for (i=0;i<User_recommend.length;i++){

            temp[i]=User_recommend[i]
        }
        tableData[0] = temp;

        $('#recommendation1').bootstrapTable('destroy');
        $('#recommendation1').bootstrapTable({
            // pagination: true,
            // pageSize:"15",
            columns:tableTitle,
            data: tableData
    ...
    function getRecommend_Item(eCode) {
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/AutoMlClassifierSelection/Recommend_Item",
            ...
            success:function (result) {
                $("#TabContent2").hide();
                var Item_recommend = result['alg_recommend'];
                getRecommendation_Item(Item_recommend);
            },
            complete: function () {
                reloadpage();
            }
    ...
    function getRecommendation_Item(Item_recommend) {
        var tableTitle = [];
        var tableData = [];
        var i;
        for(i=0;i<3;i++){
        ...
        var temp = {};
        for (i=0;i<Item_recommend.length;i++){

            temp[i]=Item_recommend[i]
        }
        tableData[0] = temp;

        $('#recommendation2').bootstrapTable('destroy');
        $('#recommendation2').bootstrapTable({
            // pagination: true,
            // pageSize:"15",
            columns:tableTitle,
            data: tableData
    ...
    function getRecommend_Model(eCode) {
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/AutoMlClassifierSelection/Recommend_Model",
            ...
            success:function (result) {
                $("#TabContent3").hide();
                var Model_recommend = result['alg_recommend'];
                getRecommendation_Model(Model_recommend);
            },
            complete: function () {
                reloadpage();
            }
    ...
    function getRecommendation_Model(Model_recommend) {
        var tableTitle = [];
        var tableData = [];
        var i;
        for(i=0;i<3;i++){
        ...
        var temp = {};
        for (i=0;i<Model_recommend.length;i++){

            temp[i]=Model_recommend[i]
        }
        tableData[0] = temp;

        $('#recommendation3').bootstrapTable('destroy');
        $('#recommendation3').bootstrapTable({
            // pagination: true,
            // pageSize:"15",
            columns:tableTitle,
            data: tableData
    ...
    function Recommend_RF() {
        window.location.href="${ctx}/page/Recommend_RF_classifier?eCode="+eCode;
    }
</script>
</html>